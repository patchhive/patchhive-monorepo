...
export default function App() {
  ...
  return (
    <div style={{ minHeight: "100vh", background: "var(--bg)", color: "var(--text)", fontFamily: "'SF Mono','Fira Mono',monospace", fontSize: 12 }}>
      <PatchHiveHeader icon="📦" title="DepTriage" version="v0.1.0" running={running}>
        <div style={{ fontSize: 10, color: "var(--text-dim)" }}>Tell teams which dependency updates matter now and which ones can wait.</div>
      ...
      <PatchHiveFooter product="DepTriage" />
    </div>
  );
}
