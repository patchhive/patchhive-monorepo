    ...
    <div style={{ display: "grid", gap: 18 }}>
      <div style={{ ...S.panel, display: "flex", justifyContent: "space-between", alignItems: "center", gap: 12, flexWrap: "wrap" }}>
        <div>
          ...
          <div style={{ color: "var(--text-dim)", fontSize: 12 }}>
            FlakeSting needs GitHub access and a healthy local DB before its flaky-CI calls mean much.
          </div>
        </div>
      ...
      {health && (
        <div style={{ ...S.panel, display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(180px, 1fr))", gap: 12 }}>
          ...
          <Stat label="Flaky Signals" value={health.flaky_signal_count} color="var(--gold)" />
          <Stat label="Quarantine Candidates" value={health.quarantine_candidate_count} color="var(--accent)" />
          <div>
