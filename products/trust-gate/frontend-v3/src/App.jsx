...
function WorkspaceDetails({ health, onError, result }) {
  ...
  return <div className="mt-8 space-y-6">
    ...
    <GitHubPermissionGuidance>A TrustGate recommendation covers diff policy only. It does not include CI results, approvals, review-thread state, mergeability, or release readiness; those remain MergeKeeper, ReviewBee, FlakeSting, and ReleaseSentry evidence.</GitHubPermissionGuidance>
