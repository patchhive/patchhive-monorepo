...
pub use repos::{
    ...
    save_scan_preset, scan_count,
};
pub use scans::{get_scan, list_scans, previous_scan_for_params, save_scan, scan_timeline};
pub use schedules::{
...
mod tests {
    ...
    fn insert_repo_signal_accepts_all_declared_columns() {
        ...
        super::scans::insert_repo_signal(&tx, "scan-1", &sample_repo_signal())
            .expect("insert repo signal");
