...
const config = {
  ...
  metrics: (result, overview, health) => {
    ...
    return result ? [
      { label: "Open items", value: metrics.open_items || 0, footerLeft: "follow-up", footerRight: countLabel(metrics.actionable_threads, "actionable thread"), tone: "from-orange-700/70 to-red-900/60" },
      { label: "Resolved", value: metrics.resolved_items || 0, footerLeft: "checklist", footerRight: "cleared", tone: "from-emerald-700/70 to-teal-900/60" },
