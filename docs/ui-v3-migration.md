...
| ReleaseSentry | `products/release-sentry/frontend-v3` | v1/v2 parity implemented and locally verified; awaiting live ready/watch/hold acceptance and operator sign-off |
